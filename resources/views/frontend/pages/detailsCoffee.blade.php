  ...
  <div class="section-details-coffee">
    <div class="container">
      ...
      <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="details-slide-body">
                    <ul class="thumbnails-carousel clearfix col-md-12">
                      @foreach(json_decode($productCoffee->images) as $key => $image)
                        <li data-target="#carousel-example-generic" data-slide-to="{{ $key }}" class="col-md-3"><img src="{{ Voyager::image($image) }}" alt="1_tn.jpg"></li>
                      @endforeach
                    </ul>
                  </div>
                  <!-- Thumbnails End -->
        ...
        {{-- Detail Kanan Start --}}
        <div class="col-md-5">
          {!! Form::open(['url' => 'add-to-cart/1/woi', 'method' => 'post']) !!}
                          ...
                          <div class="row">
                            <div class="col-md-7 flex-direction-coloumn">
                              <div class="harga-count-pembelian">
                                <span class="price-new">Rp {{ number_format($productCoffee->discounted_price) }}</span>
                                <span class="price-old">Rp {{ number_format($productCoffee->original_price) }}</span>
                              </div>
                            </div>
                            <div class="col-md-5">
